    ...
    return Config(
        ...
        v2=V2Config(
            ...
            kronos_shadow=V2KronosShadowConfig(
                ...
                model_name=v2_raw.get("kronos_shadow", {}).get("model_name", "NeoQuasar/Kronos-small"),
                tokenizer_name=v2_raw.get("kronos_shadow", {}).get("tokenizer_name", "NeoQuasar/Kronos-Tokenizer-base"),
