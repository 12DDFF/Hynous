...
├── sections.py    # Memory sections — Python-side section definitions (mirrors @nous/core/sections)
└── __init__.py
```
...
| `custom:playbook` | concept | Reusable trade setups with triggers | "Funding squeeze: short when funding > 0.1%" |
...
- **`docs/archive/nous-wiring/nous-wiring-revisions.md`** -- All 10 wiring issues (all FIXED)
- **`docs/archive/nous-wiring/more-functionality.md`** -- Remaining Nous features not yet wired
