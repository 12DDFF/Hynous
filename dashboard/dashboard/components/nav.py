...
def navbar(current_page: rx.Var[str], on_home: callable, on_chat: callable, on_journal: callable, on_memory: callable, on_data: callable = None, on_settings: callable = None, on_debug: callable = None, on_logout: callable = None) -> rx.Component:
