  ...
  for (const node of activated) {
    ...
    if (rerankData) {
      scoredNodes.push({
        ...
        subtype: rerankData.subtype
        // For per-section reranking (Issue 1)
      });
    }
  }
  return scoredNodes;
