...
| 4 | Tier 1 deletions | pending | — | — | Nous server + Python Nous client + 9 decision-injection modules + 8 memory tools + unused providers + test + prompt trim (phase 4 plan, 10 steps). Discord retained — still used by daemon notify(). |
